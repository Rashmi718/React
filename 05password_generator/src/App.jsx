        ...
        <div className='flex flex-wrap justify-center items-center
         w-96 h-12 p-2 mt-10 rounded-md text-white'>
          <h1 className='flex justify-center items-center font-bold
           font-mono text-3xl mb-2'>Password Generator </h1>
          </div>

            <div className='flex  flex-wrap justify-center items-center
            w-[40rem] h-[200px] p-2 bg-gray-800 mt-10 rounded-md gap-3'>
              
              <div className='flex w-[40rem] items-center ml-14'>
                  <input 
                  type='text'
                  value={password}
                  placeholder='Password'
                  className='w-full max-w-sm p-4 rounded-md bg-black'
                  readOnly
                  ref = {passwordRef}
                  ></input>
              ...
              <div className='flex items-center gap-x-1' >
                ...
                text-blue-600'>Length : {length}</label>
              </div>

              <div 
              className='flex items-center gap-x-1 c ml-2.5'>
                <input 
                type = "checkbox"
               ...
               <label
                className='font-mono text-lg font-bold 
                text-blue-600 ml-2'>Numbers</label>
              </div>
              ...
              className='flex items-center gap-x-1 c ml-2.5'>
               ...
               <label
                className='font-mono text-lg font-bold 
                text-blue-600 ml-2'>Characters</label>
              </div>
